...
export default function Page() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-x-hidden overflow-y-auto">
      ...
      <header className="top-0 left-0 right-0 flex flex-col lg:flex-row lg:space-x-10 lg:justify-between lg:items-center z-20 px-4 lg:px-16 py-3 lg:py-4">
      ...
      <main className="relative z-10 pt-[20px] px-3 lg:px-16 text-white lg:pb-40">
        <div className="min-h-[calc(100vh-150px)] leading-snug lg:mt-0 flex flex-col items-start text-left max-w-full lg:max-w-3xl space-y-2.5 lg:space-y-3">
          ...
          <div className="mt-4">
            <div className="leading-tight">
              <p className="mb-0 pb-0 font-bold lg:text-xl text-orange-500 leading-none">
        ...
        <div
          className="
            ...
            top-[300px]
            mb-8 
           lg:right-6 lg:mb-0 lg:top-[350px]
            z-10 text-sm lg:px-14 lg:text-base space-y-1 lg:space-y-2 text-right 
          "
        >
          <a
        ...
        <div className="max-w-7xl mx-auto space-y-20 lg:space-y-32 mt-6 lg:mt-32">
          <section className="grid grid-cols-1 lg:grid-cols-3 lg:gap-12 items-start">
            <div className="lg:col-span-1 lg:sticky lg:top-28">
              <h2 className="text-4xl lg:text-5xl font-bold text-orange-500 mb-4 lg:mb-0">
                About The
                <br />
                Transformation
              </h2>
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white/10 p-6 rounded-xl border border-white/20 backdrop-blur-sm shadow-xl">
                <p className="text-lg lg:text-xl leading-relaxed text-white/90">
                  TRANSFORMATION is the flagship Tech Fest of the School of
                  Information Technology, SRM University Sikkim. This event
                  serves as a dynamic platform for students to showcase their
                  technical skills, innovative ideas, and their dedication to
                  shaping the future of technology.
                </p>
              </div>
              <div className="bg-white/5 p-6 rounded-xl border border-white/10 backdrop-blur-sm">
                <p className="text-lg lg:text-xl leading-relaxed text-white/80">
                  Our goal is to foster creativity, critical thinking, and
                  teamwork through a lineup of exciting competitions and
                  activities. Join us for a two-day experience built to
                  challenge and motivate the tech leaders of tomorrow.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white/10 p-5 rounded-xl border border-white/20 backdrop-blur-sm shadow-xl h-full">
                <div>
                  <p className="text-2xl font-bold">Sancha Bir Gurung</p>
                  <p className="text-xs text-orange-500">Assistant Professor</p>
                </div>
                <p className="text-lg text-white/80">
                  Event Faculty Coordinator
                </p>
                <p className="text-sm text-white/60 mt-2">
                  Email: sanchabir.g@srmus.edu.in
                  <br />
                  Phone: +91 78119 28076
                </p>
              </div>

              <div className="bg-white/10 p-5 rounded-xl border border-white/20 backdrop-blur-sm shadow-xl h-full">
                <div>
                  <p className="text-2xl font-bold">P. Sivaramkumar</p>
                  <p className="text-xs text-orange-500">Assistant Professor</p>
                </div>
                <p className="text-lg text-white/80">
                  Event Faculty Coordinator
                ...
                <p className="text-sm text-white/60 mt-2">
                  Email: shivaramkumar.p@srmus.edu.in
                  <br />
                  Phone: +91 99408 72949
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white/10 p-6 rounded-xl border border-white/20 backdrop-blur-sm shadow-xl space-y-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="32"
                ...
                <p className="text-lg text-white/80">
                  The venue is equipped with high-speed Wi-Fi, modern labs, and
                  dedicated event spaces.
                </p>
                <a
                  href="https://maps.app.goo.gl/gfztS7iffR7TyufH8"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="
                    inline-flex items-center font-semibold text-orange-400
                    hover:text-orange-300 hover:underline transition-colors
                  "
                >
                  Get Directions
                  <span
      ...
      <footer className="w-full backdrop-blur-sm lg:mt-0 mt-6 text-left px-4 lg:px-16 py-4 text-xs lg:text-sm border-t border-white/10 z-10 text-white">
