  ...
  return (
    <div className="relative w-full h-screen overflow-hidden text-white px-3 lg:px-16">
      ...
      <div className="relative z-10 -mt-[90px] leading-snug lg:mt-0 flex flex-col items-start text-left h-full justify-center max-w-full lg:max-w-3xl space-y-2.5 lg:space-y-3 px-1 lg:px-0">
        <div>
          <p className="mb-0 pb-0 font-semibold text-xl text-orange-500 leading-none">2025</p>
          <h1
            ref={textRef}
            className="text-3xl lg:text-8xl mt-0 mb-0 font-extrabold uppercase tracking-widest text-white drop-shadow-[0_0_20px_rgba(192,132,252,0.7)] leading-[1.05] will-change-transform-filter"
          >
            TRANSFORMATION
          </h1>
        </div>
        ...
        <p className="text-md lg:text-2xl font-semibold leading-snug">
          Organised by <span className="text-white">School of Information &amp; Technology</span>
        </p>
