  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-900 via-violet-800 to-pink-900 text-white font-sans overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center mb-[150px] lg:mb-[100px] px-6 sm:px-8 space-y-10">
        <div className="max-w-6xl w-full">
          <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-8 lg:gap-12">
            <div className="flex flex-col lg:mt-0 -mt-[30px] lg:items-start lg:text-left">
              ...
              <p className="text-base sm:text-lg md:text-xl text-pink-100 leading-relaxed">
                ...
                <span className="block mt-2 leading-tight">
                  Showcase your creativity, inventions, and innovative projects
                  at SRM University Sikkim.
                </span>
                <span className="block font-medium mt-4">
                  Date:{" "}
                  <span className="text-purple-300">31st Oct | 1st Nov</span>
                </span>
            ...
            <div className="lg:w-1/2">
              <Image
                src="/innovators.png"
                alt="Young Innovator's Expo Illustration"
                width={1080}
                height={830}
        ...
        <div
          ref={rulesRef}
          className="w-full max-w-5xl mx-auto mt-12 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-[0_0_25px_rgba(255,255,255,0.3)] p-6 sm:p-8"
        >
          ...
          <p className="text-white/90 mb-4 sm:text-base">
            Teams submit documentation + video + registration form. Max 600
            words, PDF only, max 10MB.
          </p>

          <ol className="list-decimal list-inside text-white/90 space-y-2 sm:text-base">
            <li>Team size: 1-3 students.</li>
            <li>
              ...
              <ul className="list-disc list-inside ml-6 mt-1 space-y-1">
                ...
                <li>
                  <strong>Commercialization:</strong> Explain potential
                  (max 100 words)
                </li>
              </ul>
            </li>
            <li>
              Final round: Submit presentation (max 10 slides), send to{" "}
