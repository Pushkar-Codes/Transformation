          ...
          <div className="text-md sm:text-md md:text-base leading-relaxed space-y-4">
            <div>
              ...
              <ul className="list-disc ml-6 mt-2">
                ...
                <li>
                  Each participant/team must use their own valid student ID at
            ...
            <div>
              <strong>2. Competition Format</strong>
              <ul className="list-disc ml-6 mt-2">
                <li>
                  The competition will consist of multiple problem statements
                  (ranging from easy to advanced).
                </li>
                <li>
                  Problems will test logical thinking, problem-solving,
                  algorithms, and coding efficiency.
                </li>
                <li>
                  Allowed programming languages: C, C++, Java, Python, R, Ruby,
                  Redux, TypeScript.
                </li>
                <li>
                ...
                <li>
                  Solutions will be submitted via online judge/platform/Google
                  Classroom/manual submission.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ol className="list-decimal ml-6 mt-2 space-y-1">
                ...
                <li>
                  No External Devices/Assistance – Use of phones, notes, or
                  online forums is not allowed.
                </li>
                <li>
                  Time Limits – Each problem will have a time limit and may
                  carry different weightage.
                </li>
                <li>
                  Execution & Output – Only programs that compile and run
                  successfully will be considered.
                </li>
                <li>
                  Partial Points – Partial points will not be awarded for
                  incomplete solutions.
                </li>
                <li>
                  Code Quality – Efficient and well-structured code will be
                  preferred in tie-breakers.
                </li>
                <li>
            ...
            <div>
              <strong>4. Instructions for Participants</strong>
              <ul className="list-disc ml-6 mt-2">
                <li>
                  Report to the venue 30 minutes before the contest starts (or
                  log in early if online).
                </li>
                <li>
                  Carry your college ID card and registration confirmation.
                </li>
                <li>
                  Ensure your laptop/PC is fully charged or use the provided
                  system.
                </li>
                <li>Read each problem statement carefully before coding.</li>
                <li>
                  Save and submit your code before the deadline — late
                  submissions will not be accepted.
                </li>
                <li>
                  Maintain silence and discipline during the event. Any
            ...
            <div>
              <strong>5. Evaluation Criteria</strong>
              <ul className="list-disc ml-6 mt-2">
                <li>Correctness of output (primary factor).</li>
                <li>Time & Space efficiency of the code.</li>
                <li>Code readability and structure.</li>
                <li>Number of problems solved within the time frame.</li>
              </ul>
            </div>

            <div>
              <strong>6. Prizes & Certificates</strong>
              <ul className="list-disc ml-6 mt-2">
                <li>Certificates will be awarded to all participants.</li>
                <li>Winners & runners-up will receive special prizes.</li>
              </ul>
            </div>
          </div>
        </div>
