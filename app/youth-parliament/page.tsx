      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center px-4 lg:px-20 mt-16 space-y-10">
        <div className="max-w-4xl flex flex-col items-center justify-center">
          ...
          <p className="text-lg lg:text-xl text-white/90 leading-relaxed mt-6 max-w-3xl">
            ...
            <span className="font-semibold">Transformation 2025</span>.
          </p>
          ...
          <p className="text-white/80 mt-3 text-base max-w-2xl mx-auto">
            ...
            <span className="font-semibold">Viksit Bharat</span>.
          </p>
          ...
          <p className="text-lg lg:text-xl text-white/90 leading-relaxed mt-10">
            ...
            <span className="block font-medium mt-1">
              Organized By:{" "}
              <span className="text-purple-300 font-semibold">
                School of Information Technology (Approved by AICTE)
              </span>
            </span>
          </p>
        ...
        <div className="w-full max-w-2xl mt-10 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 lg:p-8 text-center shadow-[0_0_25px_rgba(255,255,255,0.3)]">
          ...
          <p className="text-white/90 mb-6 font-medium">Ms. Sabna Sharma</p>
        ...
        <div
          ref={rulesRef}
          className="w-full max-w-3xl mt-16 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 lg:p-8 text-left text-white/90 shadow-[0_0_25px_rgba(255,255,255,0.3)]"
        >
          <h2 className="text-2xl font-bold mb-4 text-center">
            Rules & Procedure – Lok Sabha Model
          </h2>

          <p className="mt-2 font-semibold">1️⃣ General Structure of the Session</p>
          <ul className="ml-4 mt-1 list-disc list-inside">
            ...
            <li>
              Motion for debate: One motion / resolution selected in advance (e.g., “This House believes that AI will create more jobs than it destroys in India”).
            </li>
            <li>Presiding Officer: The Speaker of the House (chosen from among participants).</li>
          </ul>

          <p className="mt-4 font-semibold">2️⃣ Roles in the Session</p>
          <ul className="ml-4 mt-1 list-disc list-inside">
            ...
            <li>Council of Ministers (8–10 students) – IT, Finance, Education, Health, Defence, etc. Support motion.</li>
            ...
            <li>Neutral / Questioning MPs (10 students) – Intervene, question both sides.</li>
            <li>Other MPs (rest) – Participate in rebuttals, short interventions.</li>
          </ul>

          <p className="mt-4 font-semibold">3️⃣ Parliamentary Language & Etiquette</p>
          <ul className="ml-4 mt-1 list-disc list-inside">
          ...
          <p className="mt-4 font-semibold">4️⃣ Order of Proceedings (Round by Round)</p>
          <ul className="ml-4 mt-1 list-disc list-inside">
            <li>Opening Round (5 min): Speaker opens House & announces motion, PM speech 3–4 min.</li>
            <li>Govt & Opposition Main Speeches (40 min total): Alternate speeches between Govt & Opposition MPs, 2–3 min each.</li>
            <li>Intervention / Question Hour Style (20 min): Neutral MPs ask questions, relevant Minister/LoP responds.</li>
            <li>Rebuttal / Short Intervention Round (20 min): Remaining MPs make short interventions, Govt & Opposition counterpoints.</li>
            <li>Closing Statements (5–10 min): LoP summarizes opposition, PM gives final reply.</li>
            <li>Voting & Adjournment (5 min): Speaker announces motion, voice vote, result declared.</li>
          </ul>

          <p className="mt-4 font-semibold">5️⃣ Time Management (90 minutes total)</p>
          <ul className="ml-4 mt-1 list-disc list-inside">
            <li>Opening: 5 min</li>
          ...
          <p className="mt-4 font-semibold">6️⃣ Standard Rules of Conduct (per MoPA Youth Parliament Guidelines)</p>
          <ul className="ml-4 mt-1 list-disc list-inside">
            <li>Speaking Time Limit: Long speeches 2–3 min, Questions/Rebuttals 30–60 sec, strictly enforced by Speaker.</li>
            <li>Points of Order: MPs may rise on a “Point of Order”, Speaker decides immediately.</li>
          ...
          <p className="mt-4 font-semibold">7️⃣ Marking / Evaluation Criteria</p>
          <ul className="ml-4 mt-1 list-disc list-inside">
      ...
      <footer className="mt-16 text-center py-6 px-4 text-xs lg:text-sm border-t border-white/10 backdrop-blur-sm text-white/80 relative z-10">
        <div className="max-w-4xl mx-auto space-y-3">
          ...
          <p className="text-white/80 text-sm leading-relaxed">
            <span className="font-semibold">Faculty Contact:</span> Ms. Sabna Sharma (Asst. Prof.) - 9734014682 <br />
