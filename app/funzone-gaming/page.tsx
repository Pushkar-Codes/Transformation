      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center px-4 lg:px-20 mt-16 space-y-10">
        <div className="max-w-4xl flex flex-col items-center justify-center">
          ...
          <p className="text-lg lg:text-xl text-white/90 leading-relaxed mt-6">
            <span className="font-semibold">Funzone Gaming</span>  where passion meets pixels!
            Compete, connect, and conquer in an arena full of energy, teamwork, and fun.
            Only the best gamers claim victory at{" "}
            <span className="font-bold text-yellow-300">TRANSFORMATION 2025</span>.
          </p>

          <p className="text-white/80 mt-3 text-base max-w-2xl mx-auto">
            Be ready with your{" "}
            <span className="text-purple-300 font-semibold">FIFA skills on PS5</span> and{" "}
            <span className="text-purple-300 font-semibold">Mobile Legends skills on Mobile</span>.{" "}
            Challenge your reflexes and show the world who’s the ultimate gamer!
          </p>
          ...
          <p className="text-lg lg:text-xl text-white/90 leading-relaxed mt-10">
            ...
            <span className="block font-medium mt-1">
              ...
              <span className="text-purple-300 font-semibold">
                Main Block SRMUS, 5th Mile Tadong | Room No: 5th Floor Lab & 504
              </span>
            </span>
          </p>
        ...
        <div className="w-full max-w-2xl mt-10 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 lg:p-8 text-center shadow-[0_0_25px_rgba(255,255,255,0.3)]">
          ...
          <p className="text-white/90 mb-6 font-medium">Mr. Samir Limboo</p>
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-center">Funzone Games & Tournament Rules</h2>

          <h3 className="text-xl font-semibold mb-2">Tournament Rules & Guidelines</h3>

          <p className="mt-2 font-semibold">1. FIFA 23 (PS5)</p>
          <p className="ml-4 mt-1">
            <span className="font-medium">Format:</span> 16 Players, 2 PlayStations (PS5), 2 players per console, Knockout (Single Elimination)
          </p>
          <p className="ml-4 mt-1">
            <span className="font-medium">Rules:</span> Match Duration: 10 mins (knockouts), 20 mins (final). Tie Breaker: Extra Time → Penalty Shootout. Team Selection: Any official in-game team. Controller: Own or provided. Conduct: Fair play required, unfair means = disqualification. Fixture Flow: Round of 16 → Quarterfinals → Semifinals → Final.
          </p>

          <p className="mt-4 font-semibold">2. Mobile Legends: Bang Bang (MLBB)</p>
          <p className="ml-4 mt-1">
            <span className="font-medium">Format:</span> 10 Teams (1 team per college). Team: 5 players + 1 substitute. Knockout (Single Elimination)
          </p>
          <p className="ml-4 mt-1">
            <span className="font-medium">Rules:</span> Match Type: Best of 1 (knockouts), Final (Best of 3/5 – as decided). Mode: Draft Pick. Devices: Bring own mobile phones & headphones. Conduct: Cheating or delay = disqualification. Substitutes: Allowed only after matches. Fixture Flow: Round of 10 → Quarterfinals → Semifinals → Final.
          </p>
      ...
      <footer className="mt-16 text-center py-6 px-4 text-xs lg:text-sm border-t border-white/10 backdrop-blur-sm text-white/80 relative z-10">
        <div className="max-w-4xl mx-auto space-y-3">
          ...
          <p className="text-white/80 text-sm leading-relaxed">
            <span className="font-semibold">Faculty Contact:</span> Mr. Samir Limboo — 7908970981
            <br />
