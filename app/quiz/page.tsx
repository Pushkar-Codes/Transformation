  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-900 via-violet-800 to-pink-900 text-white font-sans overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center mb-[150px] lg:mb-[100px] px-6 sm:px-8 space-y-10">
        <div className="max-w-6xl w-full">
          <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-8 lg:gap-12">
            <div className="flex flex-col lg:mt-0 -mt-[30px] lg:items-start lg:text-left">
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold uppercase tracking-widest text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.8)] mb-4 whitespace-nowrap">
              ...
              {/* Event Info Section */}
              <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed mt-6 px-2">
              ...
              {/* Buttons */}
              <div className="mt-6 sm:mt-8 flex flex-wrap lg:justify-start gap-3 sm:gap-4">
                <Link
            ...
            <div className="lg:w-1/2">
              <Image
                src="/quiz.png"
                alt="Digital India Quiz Show Poster"
                width={1080}
                height={830}
            ...
            <div className="p-6 sm:p-8 border-t border-white/20 lg:border-t-0 lg:border-l">
              ...
              <div className="mt-4 text-gray-200 text-sm sm:text-base leading-relaxed space-y-2">
                ...
                <a
                  ...
                  className="hover:underline block text-[#ffcc33]"
                  target="_blank"
                >
        ...
        <div
          ref={rulesRef}
          className="w-full max-w-5xl mx-auto mt-12 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-[0_0_25px_rgba(255,255,255,0.3)] p-6 sm:p-8 text-white/90"
        >
          <h2 className="text-2xl font-bold mb-6 text-center">
            Quiz Competition Rules
          </h2>

          <ol className="list-decimal list-inside space-y-2 sm:text-base">
            <li>
              <strong>Eligibility & Team:</strong> Total 4 members per team.
            </li>
            <li>
            ...
            <li>
              <strong>Points:</strong> +10 points for correct, 0 points for wrong.
            </li>
          </ol>
        </div>
      </main>
