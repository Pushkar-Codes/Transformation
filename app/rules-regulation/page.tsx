...
export default function RulesRegulation() {
  return (
    <div className="relative min-h-screen p-4 lg:p-8 bg-gradient-to-br from-purple-900 via-violet-800 to-pink-900 text-white">
      ...
      {/* --- Main Section --- */}
      <div className="w-full flex flex-col-reverse lg:flex-row justify-center items-center gap-8 lg:gap-12 lg:px-14">
      ...
      {/* --- Detailed Rules Container (UPDATED) --- */}
      <div className="mt-16 mb-4 lg:mt-24 lg:max-w-full lg:mx-auto p-6 lg:py-8 lg:px-20 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20">
        {/* Eligibility Section */}
        <section>
